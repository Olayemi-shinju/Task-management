        ...
        <div className="relative min-h-screen w-full overflow-hidden bg-slate-950 flex items-center justify-center p-4">
            ...
            <div className='relative z-10 w-full max-w-md'>
                <form className='border border-slate-800 shadow-2xl bg-sky-950/50 backdrop-blur-sm rounded-2xl p-6 sm:p-10'>
                    <h1 className='text-white text-xl text-center mb-6 font-semibold font-stretch-ultra-condensed -tracking-tight decoration-wavy'>Register</h1>

                    <div className="space-y-4">
                        <Input icon={IoMdPerson} placeholder='Name' name='name' value={formData.name} onChange={handleChange} />
                        ...
                        <Input icon={FaPhone} placeholder='Phone' name='phone' value={formData.phone} onChange={handleChange} />
                    </div>

                    <div className='flex justify-end'>
                        <Link to='/login' className='text-white cursor-pointer'>!Already have an account</Link>
                    </div>
